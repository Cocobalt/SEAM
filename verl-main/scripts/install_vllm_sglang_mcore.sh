...
pip install --no-cache-dir /mnt/ali-sh-1/usr/lihaitao/MManager/pkgs/flash_attn-2.7.4.post1+cu12torch2.6cxx11abiFALSE-cp310-cp310-linux_x86_64.whl
...
pip install --no-cache-dir /mnt/ali-sh-1/usr/lihaitao/MManager/pkgs/flashinfer_python-0.2.2.post1+cu124torch2.6-cp38-abi3-linux_x86_64.whl
